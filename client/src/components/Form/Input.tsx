...
export const inputCmnClass = "w-full px-3 py-2 rounded-lg border-2 outline-none focus:border-primary trans mt-1 text-gray-600 disabled:border-secondary-200 disabled:bg-secondary-100 disabled:text-secondary-700 shadow-customInp hover:border-secondary-100"
